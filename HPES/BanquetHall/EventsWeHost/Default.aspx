<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="EventsWeHost_Default" %>
...
<!-- End WOWSlider.com BODY section -->
        ...
        <tr>
            <td><h1 align="center">Event We Host</h1><hr solid size="5px" color="red" /></td>
        </tr>
        <tr>
            <td><h3>This is Events that we host</h3></td>
        </tr>
        <tr>
            <td>
                1. Wedding<br />
                2. Corporate Parties<br />
                3. Social Parties<br />
                4. Birthday Parties
            </td>
        </tr>
