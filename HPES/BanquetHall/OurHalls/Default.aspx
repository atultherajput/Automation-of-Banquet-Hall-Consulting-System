<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="OurHalls_Default" %>
...
<!-- End WOWSlider.com BODY section -->
        ...
        <tr>
        <td><h1 align="center">Our Halls</h1><hr solid size="5px" color="red" /></td>
        </tr>
        <tr>
            <td><h3>This is Our Halls</h3></td>
        </tr>
        <tr>
            <td>    1. Ballroom<br />
                    2. Lounge <br />
