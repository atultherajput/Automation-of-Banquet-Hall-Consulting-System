<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="PaymentPolicy.aspx.cs" Inherits="PaymentPolicy" %>
...
<!-- End WOWSlider.com BODY section -->
        ...
        <tr>
            <td><h1 align="center">Payment Policy</h1><hr solid size="5px" color="red" />
            </td>
        </tr>
        <tr>
            <td><h3>This is payment Policy.</h3>
                <p>
                    Our rate is Rs. 10000 for All types of Halls. i.e. 
                    <br />
                    1. Ballroom= Rs. 10000 <br />
                    2. Lounge = Rs. 10000 <br />
                    3. Restaurant = Rs. 10000<br />
                    <p>
                        Addition Services:-<br />
                        1. Audio System <br />
                        2. DJ System <br />
                        3. Lightning System<br />
                        4. Video Recording
                    </p>
