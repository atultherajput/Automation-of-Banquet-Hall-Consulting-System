<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="CancelationPolicy.aspx.cs" Inherits="CancelationPolicy" %>
...
<!-- End WOWSlider.com BODY section -->
        ...
        <tr>
            <td><h1 align="center">Cancelation Policy</h1><hr solid size="5px" color="red" /></td>
        </tr>
        <tr>
            <td><h3>This is Cancelation Policy</h3></td>
        </tr>
        <tr>
            <td>To Cancel Please Login to your account.</td>
        </tr>
    </table>
</asp:Content>
